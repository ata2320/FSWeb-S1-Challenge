...
// return index + " .indexte bulunan fenomen: " + dizi[index].profile - bunda hata yapam ihtimali daha yüksek
...
function fenomenEkle(dizi, numara, profil, takipci, gönderi, platform) {
  let yeniDizi = [...dizi];
  let yeniFenomen = {
    number: numara,
    profile: profil,
